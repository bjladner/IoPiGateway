      ...
      <div class="center-wrapper" style="margin-top:10px">
        <div id="nodeEvents" class="center-div">
          <div id="nodeControls" data-role="controlgroup" data-type="horizontal">
            <a id="addNodeAlert" href="#addEvent" data-role="button" data-icon="plus" style="background-color:#9BFFBE">Event</a>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        function refreshNodeDetails(node) {
		    ...
		    //var timeout = ; // make timeout readable 
		    var description = node.alerts[key].alertType + ' to ' + node.alerts[key].destination + ' after ' + (node.alerts[key].destination/60000) + ' minutes of status ' + node.alerts[key].clientStatus;
